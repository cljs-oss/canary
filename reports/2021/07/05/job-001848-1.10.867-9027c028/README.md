...
Job: **#1848** | [jobs/260c1cd](https://github.com/cljs-oss/canary/commit/260c1cd9537ec5435fdd33b3dd4779bb392cb3cc) | [options](options.edn) | [tasks](tasks.edn) | [travis log](https://travis-ci.com/cljs-oss/canary/builds/231801769).
...
{"message" "Could not authorize build request for chkup/clara-rules.",
 ...
 {"@type" "organization",
  ...
  "ro_mode" false},
 "@href" "/repo/19663828/request/576227318",
 "config"
 {"jdk" ["openjdk8"],
  "os" ["linux"],
  "lein" "2.7.1",
  ...
  {"global"
   [{"CANARY_BUILD" "1",
     ...
     "CANARY_TRAVIS_BUILD_URL" "https://travis-ci.com/cljs-oss/canary/builds/231801769"}]},
 ...
 [{"@type" "request_raw_configuration",
   "@representation" "minimal",
   "config"
   "{\"merge_mode\":\"deep_merge\",\"env\":{\"global\":{\"CANARY_BUILD\":\"1\",\"CANARY_CLOJURESCRIPT_VERSION\":\"1.10.867-9027c028\",\"CANARY_CLOJURESCRIPT_REPO\":\"https://github.com/clojure/clojurescript.git\",\"CANARY_CLOJURESCRIPT_REV\":\"9027c02852bbeb512cda728e5f0551145e921a9c\",\"CANARY_CLOJURESCRIPT_JAR_URL\":\"https://github.com/cljs-oss/canary/releases/download/r1.10.867-9027c028/clojurescript-1.10.867-9027c028.jar\",\"CANARY_TRAVIS_BUILD_URL\":\"https://travis-ci.com/cljs-oss/canary/builds/231801769\"}}}",
   "source" "api",
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:14:38Z",
 "messages"
...
{"message" "Could not authorize build request for chkup/cljs-time.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663833/request/576227365",
 "config"
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:14:42Z",
 "messages"
 [{"args" {"key" "dist", "default" "xenial"},
   "key" "root",
   "id" 270480302,
...
{"message" "Could not authorize build request for chkup/core.async.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663829/request/576227382",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:14:45Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270480308,
...
{"message" "Could not authorize build request for chkup/core.logic.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663832/request/576227386",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:14:46Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270480309,
...
{"message" "Could not authorize build request for chkup/core.match.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663831/request/576227396",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:14:47Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270480311,
...
{"message" "Could not authorize build request for chkup/core.rrb-vector.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663830/request/576227409",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:14:48Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270480314,
...
{"message" "Could not authorize build request for chkup/garden.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663821/request/576227413",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:14:49Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270480320,
...
{"message" "Could not authorize build request for chkup/om.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663822/request/576227448",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:14:52Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270480366,
...
{"message" "Could not authorize build request for planck-repl/planck.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663259/request/576227475",
 "config"
 {"compiler" ["gcc" "clang"],
  "os" ["linux" "osx"],
 ...
 [{"@type" "request_raw_configuration",
   "@representation" "minimal",
   "config"
   "{\"merge_mode\":\"deep_merge\",\"env\":{\"global\":{\"CANARY_BUILD\":\"1\",\"CANARY_CLOJURESCRIPT_VERSION\":\"1.10.867-9027c028\",\"CANARY_CLOJURESCRIPT_REPO\":\"https://github.com/clojure/clojurescript.git\",\"CANARY_CLOJURESCRIPT_REV\":\"9027c02852bbeb512cda728e5f0551145e921a9c\",\"CANARY_CLOJURESCRIPT_JAR_URL\":\"https://github.com/cljs-oss/canary/releases/download/r1.10.867-9027c028/clojurescript-1.10.867-9027c028.jar\",\"CANARY_TRAVIS_BUILD_URL\":\"https://travis-ci.com/cljs-oss/canary/builds/231801769\"}},\"jobs\":{\"exclude\":[{\"os\":\"osx\"}]}}",
   "source" "api",
   "merge_mode" "deep_merge"}
  {"@type" "request_raw_configuration",
   "@representation" "minimal",
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:14:55Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Could not authorize build request for chkup/spec-tools.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663823/request/576227525",
 "config"
 {"jdk" ["oraclejdk8"],
  "os" ["linux"],
  "lein" "2.7.1",
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:15:02Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 270480415,
...
{"message" "Could not authorize build request for chkup/test.check.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663820/request/576227497",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-05T11:14:58Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270480377,
...
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [binaryage/chromex#2587](https://travis-ci.com/binaryage/chromex/builds/231801963)<br>

#### <b style='color:green'>&#x2713; cljs-bean</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [mfikes/cljs-bean#1162](https://travis-ci.com/mfikes/cljs-bean/builds/231801966)<br>

#### <b style='color:green'>&#x2713; cljs-devtools</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [binaryage/cljs-devtools#2001](https://travis-ci.com/binaryage/cljs-devtools/builds/231801967)<br>

#### <b style='color:green'>&#x2713; cljs-oops</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [binaryage/cljs-oops#1872](https://travis-ci.com/binaryage/cljs-oops/builds/231801969)<br>

#### <b style='color:green'>&#x2713; cljs-zones</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [binaryage/cljs-zones#1497](https://travis-ci.com/binaryage/cljs-zones/builds/231801973)<br>

#### <b style='color:green'>&#x2713; coal-mine</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [mfikes/coal-mine#2922](https://travis-ci.com/mfikes/coal-mine/builds/231801974)<br>