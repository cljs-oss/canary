...
Job: **#1853** | [jobs/cb2c6be](https://github.com/cljs-oss/canary/commit/cb2c6be0ef0786521ba790c705449afcecfb04fe) | [options](options.edn) | [tasks](tasks.edn) | [travis log](https://travis-ci.com/cljs-oss/canary/builds/232365752).
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "ro_mode" false},
 "@href" "/repo/1238397/request/579034363",
 "config"
 {"language" "clojure",
  "os" ["linux"],
  "dist" "bionic",
  ...
  {"global"
   [{"CANARY_BUILD" "1",
     ...
     "CANARY_TRAVIS_BUILD_URL" "https://travis-ci.com/cljs-oss/canary/builds/232365752"}]},
 ...
 [{"@type" "request_raw_configuration",
   "@representation" "minimal",
   "config"
   "{\"merge_mode\":\"deep_merge\",\"env\":{\"global\":{\"CANARY_BUILD\":\"1\",\"CANARY_CLOJURESCRIPT_VERSION\":\"1.10.867-9027c028\",\"CANARY_CLOJURESCRIPT_REPO\":\"https://github.com/clojure/clojurescript.git\",\"CANARY_CLOJURESCRIPT_REV\":\"9027c02852bbeb512cda728e5f0551145e921a9c\",\"CANARY_CLOJURESCRIPT_JAR_URL\":\"https://github.com/cljs-oss/canary/releases/download/r1.10.867-9027c028/clojurescript-1.10.867-9027c028.jar\",\"CANARY_TRAVIS_BUILD_URL\":\"https://travis-ci.com/cljs-oss/canary/builds/232365752\"}}}",
   "source" "api",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:35Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Could not authorize build request for chkup/clara-rules.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663828/request/579034365",
 "config"
 {"jdk" ["openjdk8"],
  "os" ["linux"],
  "lein" "2.7.1",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:36Z",
 "messages"
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19650792/request/579034372",
 "config"
 {"language" "clojure",
  "os" ["linux"],
  "dist" "bionic",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:38Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19650802/request/579034375",
 "config"
 {"before_script"
  ["yes y | sudo lein upgrade"
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:39Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 272713798,
...
{"message" "Could not authorize build request for chkup/cljs-time.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663833/request/579034379",
 "config"
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:40Z",
 "messages"
 [{"args" {"key" "dist", "default" "xenial"},
   "key" "root",
   "id" 272713802,
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19650799/request/579034381",
 "config"
 {"before_script"
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:41Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 272713804,
...
{"message" "Could not authorize build request for chkup/core.async.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663829/request/579034389",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:43Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272713807,
...
{"message" "Could not authorize build request for chkup/core.logic.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663832/request/579034391",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:44Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272713808,
...
{"message" "Could not authorize build request for chkup/core.match.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663831/request/579034395",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:45Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272713809,
...
{"message" "Could not authorize build request for chkup/core.rrb-vector.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663830/request/579034396",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:46Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272713810,
...
{"message" "Could not authorize build request for chkup/garden.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663821/request/579034398",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:47Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272713811,
...
{"message" "Could not authorize build request for chkup/om.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663822/request/579034404",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:49Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272713817,
...
{"message" "Could not authorize build request for planck-repl/planck.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663259/request/579034409",
 "config"
 {"compiler" ["gcc" "clang"],
  "os" ["linux" "osx"],
 ...
 [{"@type" "request_raw_configuration",
   "@representation" "minimal",
   "config"
   "{\"merge_mode\":\"deep_merge\",\"env\":{\"global\":{\"CANARY_BUILD\":\"1\",\"CANARY_CLOJURESCRIPT_VERSION\":\"1.10.867-9027c028\",\"CANARY_CLOJURESCRIPT_REPO\":\"https://github.com/clojure/clojurescript.git\",\"CANARY_CLOJURESCRIPT_REV\":\"9027c02852bbeb512cda728e5f0551145e921a9c\",\"CANARY_CLOJURESCRIPT_JAR_URL\":\"https://github.com/cljs-oss/canary/releases/download/r1.10.867-9027c028/clojurescript-1.10.867-9027c028.jar\",\"CANARY_TRAVIS_BUILD_URL\":\"https://travis-ci.com/cljs-oss/canary/builds/232365752\"}},\"jobs\":{\"exclude\":[{\"os\":\"osx\"}]}}",
   "source" "api",
   "merge_mode" "deep_merge"}
  {"@type" "request_raw_configuration",
   "@representation" "minimal",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:53Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Could not authorize build request for chkup/spec-tools.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663823/request/579034413",
 "config"
 {"jdk" ["oraclejdk8"],
  "os" ["linux"],
  "lein" "2.7.1",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:56Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 272713832,
...
{"message" "Could not authorize build request for chkup/test.check.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663820/request/579034417",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-10T11:10:59Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272713840,
...
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [mfikes/cljs-bean#1167](https://travis-ci.com/mfikes/cljs-bean/builds/232365787)<br>

#### <b style='color:green'>&#x2713; coal-mine</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [mfikes/coal-mine#2927](https://travis-ci.com/mfikes/coal-mine/builds/232365788)<br>