...
Job: **#1854** | [jobs/239e30f](https://github.com/cljs-oss/canary/commit/239e30f186ff1b2a6787f0097e055cdeb990b12a) | [options](options.edn) | [tasks](tasks.edn) | [travis log](https://travis-ci.com/cljs-oss/canary/builds/232399731).
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "ro_mode" false},
 "@href" "/repo/1238397/request/579199886",
 "config"
 {"language" "clojure",
  "os" ["linux"],
  "dist" "bionic",
  ...
  {"global"
   [{"CANARY_BUILD" "1",
     ...
     "CANARY_TRAVIS_BUILD_URL" "https://travis-ci.com/cljs-oss/canary/builds/232399731"}]},
 ...
 [{"@type" "request_raw_configuration",
   "@representation" "minimal",
   "config"
   "{\"merge_mode\":\"deep_merge\",\"env\":{\"global\":{\"CANARY_BUILD\":\"1\",\"CANARY_CLOJURESCRIPT_VERSION\":\"1.10.867-9027c028\",\"CANARY_CLOJURESCRIPT_REPO\":\"https://github.com/clojure/clojurescript.git\",\"CANARY_CLOJURESCRIPT_REV\":\"9027c02852bbeb512cda728e5f0551145e921a9c\",\"CANARY_CLOJURESCRIPT_JAR_URL\":\"https://github.com/cljs-oss/canary/releases/download/r1.10.867-9027c028/clojurescript-1.10.867-9027c028.jar\",\"CANARY_TRAVIS_BUILD_URL\":\"https://travis-ci.com/cljs-oss/canary/builds/232399731\"}}}",
   "source" "api",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:15Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Could not authorize build request for chkup/clara-rules.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663828/request/579199892",
 "config"
 {"jdk" ["openjdk8"],
  "os" ["linux"],
  "lein" "2.7.1",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:16Z",
 "messages"
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19650792/request/579199904",
 "config"
 {"language" "clojure",
  "os" ["linux"],
  "dist" "bionic",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:18Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19650802/request/579199911",
 "config"
 {"before_script"
  ["yes y | sudo lein upgrade"
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:19Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 272800177,
...
{"message" "Could not authorize build request for chkup/cljs-time.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663833/request/579199916",
 "config"
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:20Z",
 "messages"
 [{"args" {"key" "dist", "default" "xenial"},
   "key" "root",
   "id" 272800189,
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19650799/request/579199919",
 "config"
 {"before_script"
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:21Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 272800191,
...
{"message" "Could not authorize build request for chkup/core.async.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663829/request/579199924",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:23Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272800194,
...
{"message" "Could not authorize build request for chkup/core.logic.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663832/request/579199927",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:24Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272800195,
...
{"message" "Could not authorize build request for chkup/core.match.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663831/request/579199930",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:25Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272800196,
...
{"message" "Could not authorize build request for chkup/core.rrb-vector.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663830/request/579199933",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:26Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272800197,
...
{"message" "Could not authorize build request for chkup/garden.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663821/request/579199936",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:27Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272800198,
...
{"message" "Could not authorize build request for chkup/om.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663822/request/579199954",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:34Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272800201,
...
{"message" "Could not authorize build request for planck-repl/planck.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663259/request/579199945",
 "config"
 {"compiler" ["gcc" "clang"],
  "os" ["linux" "osx"],
 ...
 [{"@type" "request_raw_configuration",
   "@representation" "minimal",
   "config"
   "{\"merge_mode\":\"deep_merge\",\"env\":{\"global\":{\"CANARY_BUILD\":\"1\",\"CANARY_CLOJURESCRIPT_VERSION\":\"1.10.867-9027c028\",\"CANARY_CLOJURESCRIPT_REPO\":\"https://github.com/clojure/clojurescript.git\",\"CANARY_CLOJURESCRIPT_REV\":\"9027c02852bbeb512cda728e5f0551145e921a9c\",\"CANARY_CLOJURESCRIPT_JAR_URL\":\"https://github.com/cljs-oss/canary/releases/download/r1.10.867-9027c028/clojurescript-1.10.867-9027c028.jar\",\"CANARY_TRAVIS_BUILD_URL\":\"https://travis-ci.com/cljs-oss/canary/builds/232399731\"}},\"jobs\":{\"exclude\":[{\"os\":\"osx\"}]}}",
   "source" "api",
   "merge_mode" "deep_merge"}
  {"@type" "request_raw_configuration",
   "@representation" "minimal",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:30Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Could not authorize build request for chkup/spec-tools.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663823/request/579199968",
 "config"
 {"jdk" ["oraclejdk8"],
  "os" ["linux"],
  "lein" "2.7.1",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:37Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 272800206,
...
{"message" "Could not authorize build request for chkup/test.check.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663820/request/579199975",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-11T11:10:40Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272800207,
...
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [mfikes/cljs-bean#1168](https://travis-ci.com/mfikes/cljs-bean/builds/232399764)<br>

#### <b style='color:green'>&#x2713; coal-mine</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [mfikes/coal-mine#2928](https://travis-ci.com/mfikes/coal-mine/builds/232399768)<br>