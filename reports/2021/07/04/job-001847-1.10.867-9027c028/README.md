...
Job: **#1847** | [jobs/ddc4b42](https://github.com/cljs-oss/canary/commit/ddc4b4229b0399bf6a9b787078128398839482b4) | [options](options.edn) | [tasks](tasks.edn) | [travis log](https://travis-ci.com/cljs-oss/canary/builds/231740737).
...
{"message" "Could not authorize build request for chkup/clara-rules.",
 ...
 {"@type" "organization",
  ...
  "ro_mode" false},
 "@href" "/repo/19663828/request/575873996",
 "config"
 {"jdk" ["openjdk8"],
  "os" ["linux"],
  "lein" "2.7.1",
  ...
  {"global"
   [{"CANARY_BUILD" "1",
     ...
     "CANARY_TRAVIS_BUILD_URL" "https://travis-ci.com/cljs-oss/canary/builds/231740737"}]},
 ...
 [{"@type" "request_raw_configuration",
   "@representation" "minimal",
   "config"
   "{\"merge_mode\":\"deep_merge\",\"env\":{\"global\":{\"CANARY_BUILD\":\"1\",\"CANARY_CLOJURESCRIPT_VERSION\":\"1.10.867-9027c028\",\"CANARY_CLOJURESCRIPT_REPO\":\"https://github.com/clojure/clojurescript.git\",\"CANARY_CLOJURESCRIPT_REV\":\"9027c02852bbeb512cda728e5f0551145e921a9c\",\"CANARY_CLOJURESCRIPT_JAR_URL\":\"https://github.com/cljs-oss/canary/releases/download/r1.10.867-9027c028/clojurescript-1.10.867-9027c028.jar\",\"CANARY_TRAVIS_BUILD_URL\":\"https://travis-ci.com/cljs-oss/canary/builds/231740737\"}}}",
   "source" "api",
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:17Z",
 "messages"
...
{"message" "Could not authorize build request for chkup/cljs-time.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663833/request/575874009",
 "config"
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:21Z",
 "messages"
 [{"args" {"key" "dist", "default" "xenial"},
   "key" "root",
   "id" 270234271,
...
{"message" "Could not authorize build request for chkup/core.async.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663829/request/575874017",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:24Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270234283,
...
{"message" "Could not authorize build request for chkup/core.logic.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663832/request/575874020",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:25Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270234284,
...
{"message" "Could not authorize build request for chkup/core.match.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663831/request/575874024",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:26Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270234285,
...
{"message" "Could not authorize build request for chkup/core.rrb-vector.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663830/request/575874027",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:27Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270234286,
...
{"message" "Could not authorize build request for chkup/garden.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663821/request/575874030",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:28Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270234287,
...
{"message" "Could not authorize build request for chkup/om.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663822/request/575874047",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:31Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270234298,
...
{"message" "Could not authorize build request for planck-repl/planck.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663259/request/575874054",
 "config"
 {"compiler" ["gcc" "clang"],
  "os" ["linux" "osx"],
 ...
 [{"@type" "request_raw_configuration",
   "@representation" "minimal",
   "config"
   "{\"merge_mode\":\"deep_merge\",\"env\":{\"global\":{\"CANARY_BUILD\":\"1\",\"CANARY_CLOJURESCRIPT_VERSION\":\"1.10.867-9027c028\",\"CANARY_CLOJURESCRIPT_REPO\":\"https://github.com/clojure/clojurescript.git\",\"CANARY_CLOJURESCRIPT_REV\":\"9027c02852bbeb512cda728e5f0551145e921a9c\",\"CANARY_CLOJURESCRIPT_JAR_URL\":\"https://github.com/cljs-oss/canary/releases/download/r1.10.867-9027c028/clojurescript-1.10.867-9027c028.jar\",\"CANARY_TRAVIS_BUILD_URL\":\"https://travis-ci.com/cljs-oss/canary/builds/231740737\"}},\"jobs\":{\"exclude\":[{\"os\":\"osx\"}]}}",
   "source" "api",
   "merge_mode" "deep_merge"}
  {"@type" "request_raw_configuration",
   "@representation" "minimal",
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:34Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Could not authorize build request for chkup/spec-tools.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663823/request/575874063",
 "config"
 {"jdk" ["oraclejdk8"],
  "os" ["linux"],
  "lein" "2.7.1",
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:38Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 270234318,
...
{"message" "Could not authorize build request for chkup/test.check.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663820/request/575874070",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-04T11:10:41Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 270234328,
...
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [binaryage/chromex#2586](https://travis-ci.com/binaryage/chromex/builds/231740791)<br>

#### <b style='color:green'>&#x2713; cljs-bean</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [mfikes/cljs-bean#1161](https://travis-ci.com/mfikes/cljs-bean/builds/231740792)<br>

#### <b style='color:green'>&#x2713; cljs-devtools</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [binaryage/cljs-devtools#2000](https://travis-ci.com/binaryage/cljs-devtools/builds/231740793)<br>

#### <b style='color:green'>&#x2713; cljs-oops</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [binaryage/cljs-oops#1871](https://travis-ci.com/binaryage/cljs-oops/builds/231740794)<br>

#### <b style='color:green'>&#x2713; cljs-zones</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [binaryage/cljs-zones#1496](https://travis-ci.com/binaryage/cljs-zones/builds/231740795)<br>

#### <b style='color:green'>&#x2713; coal-mine</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [mfikes/coal-mine#2921](https://travis-ci.com/mfikes/coal-mine/builds/231740797)<br>