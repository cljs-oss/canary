...
Job: **#1852** | [jobs/5a2d61a](https://github.com/cljs-oss/canary/commit/5a2d61ac4cb6a3db6d38607ccddbec6e498be2f6) | [options](options.edn) | [tasks](tasks.edn) | [travis log](https://travis-ci.com/cljs-oss/canary/builds/232274415).
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "ro_mode" false},
 "@href" "/repo/1238397/request/578623687",
 "config"
 {"language" "clojure",
  "os" ["linux"],
  "dist" "bionic",
  ...
  {"global"
   [{"CANARY_BUILD" "1",
     ...
     "CANARY_TRAVIS_BUILD_URL" "https://travis-ci.com/cljs-oss/canary/builds/232274415"}]},
 ...
 [{"@type" "request_raw_configuration",
   "@representation" "minimal",
   "config"
   "{\"merge_mode\":\"deep_merge\",\"env\":{\"global\":{\"CANARY_BUILD\":\"1\",\"CANARY_CLOJURESCRIPT_VERSION\":\"1.10.867-9027c028\",\"CANARY_CLOJURESCRIPT_REPO\":\"https://github.com/clojure/clojurescript.git\",\"CANARY_CLOJURESCRIPT_REV\":\"9027c02852bbeb512cda728e5f0551145e921a9c\",\"CANARY_CLOJURESCRIPT_JAR_URL\":\"https://github.com/cljs-oss/canary/releases/download/r1.10.867-9027c028/clojurescript-1.10.867-9027c028.jar\",\"CANARY_TRAVIS_BUILD_URL\":\"https://travis-ci.com/cljs-oss/canary/builds/232274415\"}}}",
   "source" "api",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:29Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Could not authorize build request for chkup/clara-rules.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663828/request/578623692",
 "config"
 {"jdk" ["openjdk8"],
  "os" ["linux"],
  "lein" "2.7.1",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:30Z",
 "messages"
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19650792/request/578623703",
 "config"
 {"language" "clojure",
  "os" ["linux"],
  "dist" "bionic",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:32Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19650802/request/578623715",
 "config"
 {"before_script"
  ["yes y | sudo lein upgrade"
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:33Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 272419040,
...
{"message" "Could not authorize build request for chkup/cljs-time.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663833/request/578623721",
 "config"
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:34Z",
 "messages"
 [{"args" {"key" "dist", "default" "xenial"},
   "key" "root",
   "id" 272419042,
...
{"message" "Owner binaryage does not have enough credits.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19650799/request/578623728",
 "config"
 {"before_script"
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:35Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 272419044,
...
{"message" "Could not authorize build request for chkup/core.async.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663829/request/578623740",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:37Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272419071,
...
{"message" "Could not authorize build request for chkup/core.logic.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663832/request/578623753",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:38Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272419072,
...
{"message" "Could not authorize build request for chkup/core.match.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663831/request/578623761",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:39Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272419077,
...
{"message" "Could not authorize build request for chkup/core.rrb-vector.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663830/request/578623769",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:40Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272419094,
...
{"message" "Could not authorize build request for chkup/garden.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663821/request/578623776",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:41Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272419095,
...
{"message" "Could not authorize build request for chkup/om.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663822/request/578623798",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:45Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272419112,
...
{"message" "Could not authorize build request for planck-repl/planck.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663259/request/578623841",
 "config"
 {"compiler" ["gcc" "clang"],
  "os" ["linux" "osx"],
 ...
 [{"@type" "request_raw_configuration",
   "@representation" "minimal",
   "config"
   "{\"merge_mode\":\"deep_merge\",\"env\":{\"global\":{\"CANARY_BUILD\":\"1\",\"CANARY_CLOJURESCRIPT_VERSION\":\"1.10.867-9027c028\",\"CANARY_CLOJURESCRIPT_REPO\":\"https://github.com/clojure/clojurescript.git\",\"CANARY_CLOJURESCRIPT_REV\":\"9027c02852bbeb512cda728e5f0551145e921a9c\",\"CANARY_CLOJURESCRIPT_JAR_URL\":\"https://github.com/cljs-oss/canary/releases/download/r1.10.867-9027c028/clojurescript-1.10.867-9027c028.jar\",\"CANARY_TRAVIS_BUILD_URL\":\"https://travis-ci.com/cljs-oss/canary/builds/232274415\"}},\"jobs\":{\"exclude\":[{\"os\":\"osx\"}]}}",
   "source" "api",
   "merge_mode" "deep_merge"}
  {"@type" "request_raw_configuration",
   "@representation" "minimal",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:51Z",
 "messages" [],
 "head_commit" nil,
 "@type" "request",
 "result" "rejected"}
...
{"message" "Could not authorize build request for chkup/spec-tools.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663823/request/578623816",
 "config"
 {"jdk" ["oraclejdk8"],
  "os" ["linux"],
  "lein" "2.7.1",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:48Z",
 "messages"
 [{"args" {"key" "sudo", "info" "The key `sudo` has no effect anymore."},
   "key" "root",
   "id" 272419115,
...
{"message" "Could not authorize build request for chkup/test.check.",
 ...
 {"@type" "organization",
  ...
  "vcs_type" "GithubOrganization",
  "ro_mode" false},
 "@href" "/repo/19663820/request/578623871",
 "config"
 {"language" "node_js",
  "os" ["linux"],
  "dist" "trusty",
 ...
 "state" "approved",
 "created_at" "2021-07-09T11:11:55Z",
 "messages"
 [{"args" {"key" "os", "default" "linux"},
   "key" "root",
   "id" 272419148,
...
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [mfikes/cljs-bean#1166](https://travis-ci.com/mfikes/cljs-bean/builds/232274638)<br>

#### <b style='color:green'>&#x2713; coal-mine</b>
&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:green'>&#x2713;</b> Travis build [mfikes/coal-mine#2926](https://travis-ci.com/mfikes/coal-mine/builds/232274640)<br>